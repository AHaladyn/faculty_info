        ...
        var e = /\blang(?:uage)?-([\w-]+)\b/i, t = 0, a = _self.Prism = {
            ...
            languages: {
                extend: function (e, t) {
                    ...
                    var u = r[e];
                    return r[e] = l, a.languages.DFS(a.languages, function (t, a) {
                        a === u && t != e && (this[t] = l)
                    }), l
                    ...
                    for (var o in e) if (e.hasOwnProperty(o)) {
                        t.call(e, o, e[o], n || o);
                        var s = e[o], u = a.util.type(s);
                        "Object" !== u || r[i(s)] ? "Array" !== u || r[i(s)] || (r[i(s)] = !0, l(s, t, o, r)) : (r[i(s)] = !0, l(s, t, null, r))
                    }
                }
            },
            plugins: {},
            ...
            highlightAllUnder: function (e, t, n) {
                ...
                for (var i, l = r.elements || e.querySelectorAll(r.selector), o = 0; i = l[o++];) a.highlightElement(i, t === !0, r.callback)
            },
            highlightElement: function (t, n, r) {
                for (var i, l, o = t; o && !e.test(o.className);) o = o.parentNode;
                o && (i = (o.className.match(e) || [, ""])[1].toLowerCase(), l = a.languages[i]), t.className = t.className.replace(e, "").replace(/\s+/g, " ") + " language-" + i, t.parentNode && (o = t.parentNode, /pre/i.test(o.nodeName) && (o.className = o.className.replace(e, "").replace(/\s+/g, " ") + " language-" + i));
                var s = t.textContent, u = {element: t, language: i, grammar: l, code: s}, g = function (e) {
                ...
                if (a.hooks.run("before-sanity-check", u), !u.code) return a.hooks.run("complete", u), void 0;
                if (a.hooks.run("before-highlight", u), !u.grammar) return g(a.util.encode(u.code)), void 0;
                if (n && _self.Worker) {
            ...
            matchGrammar: function (e, t, n, r, i, l, o) {
                ...
                for (var u in n) if (n.hasOwnProperty(u) && n[u]) {
                    ...
                    for (var c = 0; c < g.length; ++c) {
                        var f = g[c], h = f.inside, d = !!f.lookbehind, m = !!f.greedy, p = 0, y = f.alias;
                        ...
                        for (var k = r, b = i; k < t.length; b += t[k].length, ++k) {
                            ...
                            if (!(w instanceof s)) {
                                if (m && k != t.length - 1) {
                                    ...
                                    var _ = f.exec(e);
                                    if (!_) break;
                                    for (var P = _.index + (d ? _[1].length : 0), A = _.index + _[0].length, O = k, x = b, N = t.length; N > O && (A > x || !t[O].type && !t[O - 1].greedy); ++O) x += t[O].length, P >= x && (++k, b = x);
                                ...
                                if (_) {
                                    ...
                                    var P = _.index + p, _ = _[0].slice(p), A = P + _.length, S = w.slice(0, P),
                                        E = w.slice(A), C = [k, j];
                                    S && (++k, b += S.length, C.push(S));
                                    var M = new s(u, h ? a.tokenize(_, h) : _, y, _, m);
                                    if (C.push(M), E && C.push(E), Array.prototype.splice.apply(t, C), 1 != j && a.matchGrammar(e, t, n, k, b, !0, u), l) break
                                } else if (l) break
                            }
                        }
                    }
