        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <%--WYSWIETL ZE MA WYSLAĆ ZDJĘCIE--%>
                    <%--<h3 style="color:green;font-weight: 900;"><c:out value="${resultMessage}"/></h3>--%>
                    <h2>My Articles</h2>
                    <div class="entry-content">

                        <h3><span style="font-size: 12pt;"><a
                                href="/author/myarticle/finished">Approved articles</a></span><br>
                            <span style="font-size: 12pt;"><a
                                    href="/author/myarticle/saved">Saved articles</a></span><br>
                            <span style="font-size: 12pt;"><a
                                    href="/author/myarticle/rejected">Rejected article</a></span><br></h3>
