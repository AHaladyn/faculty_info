                ...
                <div class="menu-primary-container">
                    <ul id="menu-primary" class="menu">
                        <li id="menu-item-1"
                            ...
                            <a href="http://localhost:8888/author/">Home</a></li>
                        <li id="menu-item-2" class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                href="/author/wtool/">Publication tool</a></li>
                        <li id="menu-item-7"
    ...
    <div id="content" class="site-content site-container ">
                            ...
                            <div class="post-loop-content">
                                ...
                                <footer class="entry-footer">
                                            <span class="cat-links">Posted in <a
                                                    href="/author/category/science/<c:out value="${record.category}"/>"
        ...
        <div id="secondary" class="widget-area" role="complementary">
            ...
            <aside id="categories-2" class="widget widget_categories"><h2 class="widget-title">Categories</h2>
                <ul>
                    <li class="cat-item cat-item-2"><a href="/author/category/sport/">Sport</a>
                    </li>
                    <li class="cat-item cat-item-3"><a href="/author/category/science/">Science</a>
                    </li>
                    <li class="cat-item cat-item-12"><a href="/author/category/entertainment/">Entertainment</a>
                    </li>
                    <li class="cat-item cat-item-4"><a href="/author/category/faculty/">Faculty</a>
                    </li>
                    <li class="cat-item cat-item-1"><a href="/author/category/uncategorized/">No category</a>
                    </li>
                </ul>
            </aside>
