                ...
                <div class="menu-primary-container">
                    <ul id="menu-primary" class="menu">
                        ...
                        <li id="menu-item-5"
                            ...
                            <a href="/standard/sciboard/">Scientific Board</a></li>
            ...
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <header class="entry-header">
                        <h1 class="entry-title">Scientific Board</h1>
                    </header>
                    <div class="entry-content">

                        <h4><strong>The members of Scientific Board of Student Publication Site "Faculty Info"
                            are:</strong></h4>
                        <h3><span style="font-size: 12pt;">John Doe, B.S.C.S</span><br>
                            <span style="font-size: 12pt;">John Doe, B.S.</span><br>
                            <span style="font-size: 12pt;">John Doe, M.E.</span><br>
                            <span style="font-size: 12pt;">John Doe, M.Sw.E</span></h3>
