...
<div class="content-container extra-padded">
    <div id="content" class="site-content site-container ">
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <p><strong>Users properties changing tool</strong></p>
                        ...
                        <c:forEach items="${userList}" var="user">
                            <tr style="margin-top: 10px">
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${user.enabled}">
                                                <button name="userEnabled" class="btn btn-danger" type="submit">
                                                    Deactivate
                                                </button>
                                            </c:when>
                                            <c:otherwise>
                                                <button name="userEnabled" class="btn btn-success" type="submit">
                                                    Activate
                                                </button>
                                            </c:otherwise>
                                        </c:choose>
                                ...
                                <%--<form method="get">--%>
                                    ...
                                    <%--<td>--%>
                                        <%--<c:choose>--%>
                                            <%--<c:when test="${authorities = 'standard'}">--%>
                                                <%--<button name="roleChange" class="btn btn-danger" type="submit">Change to--%>
                                                    <%--author--%>
                                                <%--</button>--%>
                                            <%--</c:when>--%>
                                            <%--<c:otherwise>--%>
                                                <%--<button name="roleChange" class="btn btn-success" type="submit">Change--%>
                                                    <%--to standard--%>
                                                <%--</button>--%>
                                            <%--</c:otherwise>--%>
                                        <%--</c:choose>--%>
        ...
        <div id="secondary" class="widget-area" role="complementary">
            ...
            <%--<button name="userEnabled" class="fas fa-search" type="submit"></button>--%>
            <%--</a>--%>
            <%--</div></form>--%>
            <%--</aside>--%>
