                    ...
                    <ul id="menu-primary" class="menu">
                        ...
                        <li id="menu-item-3"
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-33"
                                    class="menu-item menu-item-type-post_type menu-item-object-page current_page_item">
            ...
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <c:forEach items="${articleList}" var="record">
                        <c:if test="${record.category =='entertainment'}">
                            <article id="post"
                                ...
                                <div class="post-loop-content">
                                    ...
                                    <footer class="entry-footer">
                                            <span class="cat-links">Posted in <a
                                                    href="/standard/category/<c:out value="${record.category}"/>"
                    ...
                    <nav class="navigation paging-navigation" role="navigation">
                        ...
                        <div class="nav-links">
                            <div class="nav-previous"><a href="/standard/page/2/">Older posts <span
