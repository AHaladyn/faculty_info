                    ...
                    <ul id="menu-primary" class="menu">
                        ...
                        <li id="menu-item-7"
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-72" class="menu-item menu-item-type-post_type menu-item-object-page current_page_item">
                        ...
                        <div class="article">
                            <form id="articleForm" name="articleForm" method="get">
                                <c:forEach items="${autartList}" var="record">
                                    <c:if test="${record.finished =='false' && record.rejected =='false'}">
