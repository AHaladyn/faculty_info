                    ...
                    <ul id="menu-primary" class="menu">
                        ...
                        <li id="menu-item-7"
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-73" class="menu-item menu-item-type-post_type menu-item-object-page current_page_item">
        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <h2><strong>Rejected Articles</strong></h2>

                    <div class="article-content">
                        <div class="article">
                            <form id="articleForm" name="articleForm" method="get">
                                <c:forEach items="${autartList}" var="record">
                                    <c:if test="${record.finished =='false' && record.rejected =='true'}">
                                        <article id="post" class="post">
                                            <div class="post-loop-content">
                                                <div class="entry-content">
                                                    </br>
                                                    <h3>Why was your article rejected</h3>
                                                    <h4><c:out value="${record.whyreject}"/></h4>
                                                    <form method="get">
                                                        ...
                                                        <div class="form-group" style="padding-bottom: 10px">
                                                            ...
                                                            <button name="article-submit" type="submit"
                                                                    class="primary submit-btn">Send article to proofread
                                                            </button>
                                                        </div>
                                                        </br>
                                                        <div class="form-group" style="padding-bottom: 10px">
                                                            <input id="save_id" name="save_id" type="hidden" value='${record.id}'>
                                                            <button name="article-save" type="submit"
                                                                    class="primary submit-btn">Save article
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
