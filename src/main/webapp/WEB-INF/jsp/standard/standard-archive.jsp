                ...
                <div class="menu-primary-container">
                    <ul id="menu-primary" class="menu">
                        ...
                        <li id="menu-item-2"
                            ...
                            <a href="/standard/archive/">Archives</a></li>
                        <li id="menu-item-3"
                ...
                <div class="archive-container">
                    ...
                    <c:if test="${!empty archiveList}">
                        <table class="data">
                            ...
                            <c:forEach items="${archiveList}" var="record">
                                <tr>
                                    <td width="100px">${record.name}</td>
                                    <td width="250px">${record.description}</td>
                                    <td width="20px">
                                        <a href="download/${record.id}"><i class="fas fa-download"
                                                                           title="Download this issue"></i></a>
