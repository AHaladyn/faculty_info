        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <p><strong>Article requirements adding tool</strong></p>
                                        ...
                                        <article id="post" class="post">
                                            <div class="post-loop-content">
                                                <div class="entry-content">
                                                    <textarea name="requirement"><c:out value="${record.requirement}"/></textarea>
                                                    </br>
                                                    </br>
                                                    <form method="get">
                                                        <div class="form-group" style="padding-bottom: 10px">
                                                            <input name="requirementid" type="hidden" value="${record.id}">
                                                            <button name="requirement-update" type="submit"
                                                                    class="primary submit-btn">Update requirements
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
