        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    <h2 style="color:green"><c:out value="${success}"></c:out></h2>
                    <div class="code-block code-block-1"
                         style="margin: 8px auto; text-align: center; display: block; clear: both;"></div>
                    <form  method="get">
                        <button name="articles" style="margin-bottom: 50px" class="button" type="submit">Download articles</button>
                            ...
                            <div class="post-loop-content">
                                <header class="entry-header">
                                    <h2 class="entry-title">
                                        <td><input id="${record.id}" name="art_id" type="checkbox" value="${record.id}"> <c:out value="${record.title}"/></td>
                                    </h2>
                                ...
                                <div id="read-more" class="read-more">
                                    ...
                                    <p class="prompt">
                                        <a class="button" href="/admin/article/list/<c:out value="${record.id}"/>">Read
                                            More</a>
                                    </p>
                                </div>
