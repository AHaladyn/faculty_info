                ...
                <div class="menu-primary-container">
                    <ul id="menu-primary" class="menu">
                        <li id="menu-item-1" class="menu-item menu-item-type-custom menu-item-object-custom"><a
                                href="http://localhost:8888/standard/">Home</a></li>
                        ...
                        <li id="menu-item-4"
                            ...
                            <a href="/standard/htba/">How to become an Author</a></li>
        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <p><strong>How to become an Author</strong></p>
                    <p>Come to our office with some kind of piece of writing you made or </p>
                    <p>Write us an e-mail with your short article and your username to admin@admin.com</p>
                    <p></p>
                    <p>After we proofread through your article and contact you that you made it.</p>
                    <p>Your account privileges will be changed, you will now have an option to write your articles
                        online with our tool.</p>

                    <p>Take special precaution !!! <strong>If you will overuse your author privileges your account will
                        be returned to standard</strong></p>
