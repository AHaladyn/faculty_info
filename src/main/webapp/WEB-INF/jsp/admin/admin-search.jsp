    ...
    <div id="content" class="site-content site-container ">
        ...
        <div id="secondary" class="widget-area" role="complementary">
            ...
            <aside id="categories-2" class="widget widget_categories"><h2 class="widget-title">Categories</h2>
                <ul>
                    <li class="cat-item cat-item-2"><a href="/admin/category/sport/">Sport</a>
                    </li>
                    <li class="cat-item cat-item-3"><a href="/admin/category/science/">Science</a>
                    </li>
                    <li class="cat-item cat-item-12"><a href="/admin/category/entertainment/">Entertainment</a>
                    </li>
                    <li class="cat-item cat-item-4"><a href="/admin/category/faculty/">Faculty</a>
                    </li>
                    <li class="cat-item cat-item-1"><a href="/admin/category/uncategorized/">No category</a>
                    </li>
                </ul>
            </aside>
