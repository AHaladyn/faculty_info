            ...
            <div class="main-navigation-inner">
                <div class="menu-primary-container">
                    <ul id="menu-primary" class="menu">
                        ...
                        <li id="menu-item-3"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children current-menu-item current_page_item">
            ...
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <div class="entry-content">
                        ...
                        <h3><span style="font-size: 12pt;"><a href="/standard/category/sport/">Sport</a></span><br>
                            <span style="font-size: 12pt;"><a href="/standard/category/science/">Science</a></span><br>
                            <span style="font-size: 12pt;"><a href="/standard/category/entertainment/">Entertainment</a></span><br>
                            <span style="font-size: 12pt;"><a href="/standard/category/faculty/">Faculty</a></span><br>
                            <span style="font-size: 12pt;"><a
                                    href="/standard/category/uncategorized/">No category</a></span></h3>
