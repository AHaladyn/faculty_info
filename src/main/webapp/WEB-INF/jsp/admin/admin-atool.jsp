        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <p><strong>Article adding tool</strong></p>

                    <div class="article-content">
                        <div class="article">
                            <form id="articleForm" name="articleForm" method="get">
                                <c:forEach items="${autartList}" var="record">
                                    <c:if test="${record.finished =='true' && record.rejected =='false'}">
                                    <article id="post" class="post">
                                        <div class="post-loop-content">
                                            <div class="entry-content">
                                                <form method="get">
                                                    <input type="text" name="title_s" id="title" value="<c:out value='${record.title}'/>">
                                                    </br></br>
                                                    <textarea name="con_s" id="con"><c:out value='${record.content}'/></textarea>
                                                    </br>
                                                <select name="fields"
                                                        class="textfield" tabindex="1" id="field_1" required>
                                                    <option value="" disabled selected hidden>Select category</option>
                                                    <option value="sport">Sport</option>
                                                    <option value="cs">Science - Computer Science</option>
                                                    <option value="ee">Science - Electrical Engineering</option>
                                                    <option value="et">Science - Energy Technology</option>
                                                    ...
                                                    <div class="form-group" style="padding-bottom: 10px">
                                                        <input id="submit_id" name="submit_id" type="hidden" value='${record.id}'>
                                                        <button name="article-submit" type="submit"
                                                                class="primary submit-btn">Accept article and publish
                                                        </button>
                                                    </div>
                                                </form>
                                                </br>
                                                <form method="get">
                                                    <input type="text" id="why" name="why_r" placeholder="Why are you rejecting this article">
                                                    </br></br>
                                                    <div class="form-group" style="padding-bottom: 10px">
                                                        <input id="reject_id" name="reject_id" type="hidden" value='${record.id}'>
                                                        <input id="title_r" name="title_r" type="hidden" value='${record.title}'>
                                                        <input id="con_r" name="con_r" type="hidden" value='${record.content}'>
                                                        <button name="article-reject" type="submit"
                                                                class="primary submit-btn">Reject article
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                    ...
                    <nav class="navigation paging-navigation" role="navigation">
                        ...
                        <div class="nav-links">
                            <div class="nav-previous"><a href="/admin/page/2/">Older articles to add<span
