...
@Controller
public class AuthorArchiveController {

    @Autowired
    private ArchiveService archiveService;

    @Autowired
    private AuthorArchiveController(ArchiveService archiveService) {
    ...
    @RequestMapping("/author/archive/download/{archiveId}")
    ...
    @RequestMapping("/author/archive")
    public String Archive(Model model) {
        model.addAttribute("archiveList", archiveList());
        model.addAttribute("message", "Archive !!!");
        return "author/author-archive";
    }
}
