        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <h2>Issue adding tool</h2>
                    <h3>Add new issue to archive</h3>
                    <div class="upload-content">
                        <div class="upload">
                            <form id="uploadForm" name="uploadForm" enctype="multipart/form-data" method="get">
                                </br>
                                <input type="text" placeholder="Issue Name" class="form-control" name="issueName"
                                       autofocus="true"></br>
                                </br>
                                <input type="text" placeholder="Description" class="form-control" name="desc"></br>
                                </br>
                                <input id="file" type="file" name="file" class="file-input" size="50" required/></br>
                                </br>
                                <button name="archives" type="submit" class="primary submit-btn">Add Issue</button>
                            </form>
                        </div>
                    </div>
