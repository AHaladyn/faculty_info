        ...
        <div id="primary" class="content-area ">
            <main id="main" class="site-main" role="main">
                <div class="archive-container">
                    ...
                    <h2 class="text-center">Did you forget your password ?</h2>
                    <p>You can send reset request to your mail here</p>
                    <div class="panel-body">

                        <form id="register-form" class="forgot-form" role="form" autocomplete="off" class="form"
                              method="post">
                        ...
                        <span class="login-return" style="padding-bottom: 10px"><a
                                href="/login">Return to login page</a></span>
